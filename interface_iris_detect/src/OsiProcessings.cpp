...
{    
	...
	void OsiProcessings::mySegment(const IplImage * pSrc, IplImage * pMask, OsiCircle & rPupil, OsiCircle & rIris, std::vector<float>& rThetaCoarsePupil, std::vector<float>& rThetaCoarseIris, std::vector<CvPoint>& rCoarsePupilContour, std::vector<CvPoint>& rCoarseIrisContour, int minIrisDiameter, int minPupilDiameter, int maxIrisDiameter, int maxPupilDiameter)
	{
		// Check arguments
		//////////////////
